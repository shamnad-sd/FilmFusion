...
const Navbar = ({ searchTerm, setSearchTerm, handleSearch, isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? ' backdrop-blur-lg shadow-lg' : 'bg-transparent'}`}>
